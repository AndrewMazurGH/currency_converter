...
export class ConversionRatesService {
  ...
  private access_key = '568ee0e22b3f22ceb277bf99d855db2b';
  ...
  getLatestExchangeRates(
    ...
    const url = `${this.baseUrl}?base=${baseCurrencyCode}&symbols=${otherCurrencyCodes.join(',')}&access_key=${this.access_key}`;
